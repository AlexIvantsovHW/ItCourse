...
class Game {
    ...
    getRandMove() {return ~~(Math.random() * this.moves.length);}
    getPcMove() {
        this.key = this.generator.generateKey();
        this.computerMove = this.moves[this.getRandMove()];
    ...
    play(userMoveIndex) {
        ...
        const winner = this.rules.getWinner(this.userMove, this.computerMove);
    ...
    getResult() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                ...
                if (userMoveIndex === 0) {console.log('Exit!');return;}
    ...
    displayResult() {
        ...
        console.log(`PC move: ${this.computerMove}`);
